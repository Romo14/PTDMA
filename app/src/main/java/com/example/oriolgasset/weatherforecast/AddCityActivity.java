    ...
    public class getWeatherList extends AsyncTask<LatLng, Void, WeatherModel> {
        ...
        protected WeatherModel doInBackground(LatLng... params) {
            ...
            if (searchByLatLng) {
                ...
                data = weatherClient.getWeatherData("forecast", null, cityName, 1);
            }
        ...
        protected void onPostExecute(WeatherModel weather) {
            if (weather != null) {
                ...
                cityName = weather.getLocation().name + ", " + countryCodes.getCode(weather.getLocation().country);
