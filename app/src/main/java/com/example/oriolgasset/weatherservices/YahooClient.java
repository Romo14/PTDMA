...
public class YahooClient {
    ...
    private static String APPID = "dj0yJmk9WXM1MlptaWZTTWZqJmQ9WVdrOWFFeGhlVVJqTkhVbWNHbzlNQS0tJnM9Y29uc3VtZXJzZWNyZXQmeD00Mw--";

    public static List<YahooCityResult> getCityList(String cityName) {
        List<YahooCityResult> result = new ArrayList<YahooCityResult>();
    ...
    public static void getWeather(String woeid, String unit, RequestQueue rq, final WeatherClientListener listener) {
        ...
        final YahooVO result = new YahooVO();
    ...
    private static YahooVO parseResponse(String resp, YahooVO result) {
    ...
    private static String makeQueryCityURL(String cityName) {
        ...
        return YAHOO_GEO_URL + "/places.q(" + cityName + "%2A);" + "?appid=" + APPID;
    }
